...
<div class="card">
            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-events">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.events.fields.title') }}
                        </th>
                        <th>
                            {{ trans('cruds.events.fields.bg') }}
                        </th>
                        <th>
                            {{ trans('cruds.events.fields.sub_title') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($events as $key => $event)
                        <tr data-entry-id="{{ $event->id }}">
                            ...
                            <td>
                                @can('events_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('singleEvent', [$event->id,$event->slug??'test']) }}">
                                       Frontend
                                    </a>
    ...
    <style>
        div.dt-button-collection{width: auto}
    </style>
@endsection
@section('scripts')
@parent
